    ...
    <div className="relative mb-10">
      {product != null && (
        <>
          ...
          <div
            className={`fixed flex items-center justify-center bottom-5 right-5 w-12 h-12 rounded-full bg-white ring-2 ring-seventh ring-offset-0 hover:ring-offset-4 hover:ring-offset-[#060911] transition-all duration-300 hover:cursor-pointer z-[100] ${
              showButton ? "opacity-100" : "opacity-0 pointer-events-none"
            }`}
            onClick={scrollToTop}
          >
            <i className="bi bi-arrow-up-short text-3xl text-seventh" />
          </div>
        </>
      )}
    </div>
