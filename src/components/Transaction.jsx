...
const Transaction = () => {
  ...
  return (
    <div className="container">
      <section className="">
        <div className="w-full min-h-30 bg-secondary_opacity backdrop-blur-4xl px-4 py-10 rounded-2xl flex items-center justify-center overflow-hidden">
          <div className="w-full min-h-20 flex flex-col items-center gap-10 z-20">
            ...
            <div className="w-[100%] md:w-[80%] xl:w-[55%] min-h-30 bg-secondary_opacity ring-2 ring-slate-400 shadow-xl shadow-slate-900 rounded-lg p-6 flex flex-col gap-4">
