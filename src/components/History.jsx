      ...
      <section className="">
        <div className="bg-secondary p-4 md:px-8 md:py-6 backdrop-blur-4xl rounded-xl">
          ...
          {currentItems?.map((item) => (
            <div
              className="relative w-full min-h-[7.5rem] bg-secondary rounded-lg ring-2 ring-seventh ring-offset-0 transition-all duration-300 hover:ring-offset-8 hover:ring-offset-secondary flex flex-col xl:flex-row px-4 py-2 gap-2 mb-8 hover:cursor-pointer overflow-hidden"
              key={item.id}
